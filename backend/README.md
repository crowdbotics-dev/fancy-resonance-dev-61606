...
## Project Structure
    ...
    ├── fancy_resonance_dev_61606  # Django project configurations
...
1. Clone this repo and `cd fancy_resonance_dev_61606`
...
2. Clone this repo and `cd fancy_resonance_dev_61606`
